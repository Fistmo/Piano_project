...
public class MusicNoteCodes : MonoBehaviour
{
    ...
    public AudioSource C2_Note;
    public AudioSource D2_Note;
    public AudioSource E2_Note;
    public AudioSource F2_Note;
    public AudioSource G2_Note;
    public AudioSource A2_Note;
    public AudioSource B2_Note;
    public AudioSource CS2_Note;
    public AudioSource DS2_Note;
    public AudioSource FS2_Note;
    public AudioSource GS2_Note;
    public AudioSource Bb2_Note;
    public AudioSource G1_Note;
    public AudioSource A1_Note;
    public AudioSource B1_Note;
    public AudioSource FS1_Note;
    public AudioSource GS1_Note;
    public AudioSource Bb1_Note;
    ...
    public void C2_Note_Play()
    {
        C2_Note.Play();
    }
    public void D2_Note_Play()
    {
        D2_Note.Play();
    }
    public void E2_Note_Play()
    {
        E2_Note.Play();
    }
    public void F2_Note_Play()
    {
        F2_Note.Play();
    }
    public void G2_Note_Play()
    {
        G2_Note.Play();
    }
    public void A2_Note_Play()
    {
        A2_Note.Play();
    }
    public void B2_Note_Play()
    {
        B2_Note.Play();
    }
    public void CS2_Note_Play()
    {
        CS2_Note.Play();
    }
    public void DS2_Note_Play()
    {
        DS2_Note.Play();
    }
    public void FS2_Note_Play()
    {
        FS2_Note.Play();
    }
    public void GS2_Note_Play()
    {
        GS2_Note.Play();
    }
    public void Bb2_Note_Play()
    {
        Bb2_Note.Play();
    }
    ...
    public void A1_Note_Play()
    {
        A1_Note.Play();
    }
    public void B1_Note_Play()
    {
        B1_Note.Play();
    }
    ...
    public void GS1_Note_Play()
    {
        GS1_Note.Play();
    }
    public void Bb1_Note_Play()
    {
        Bb1_Note.Play();
    }
}
